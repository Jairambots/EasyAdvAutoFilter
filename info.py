...
API_ID = int(environ.get('API_ID', '21024769'))
API_HASH = environ.get('API_HASH', '43e195a7d59afb595222028b9e498010')
BOT_TOKEN = environ.get('BOT_TOKEN', "8130201928:AAHblOjAOaKvjnN2anX8aawoWLOGnIhXl88")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001902486281').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002134364692')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001902486281')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegrame_Files')
